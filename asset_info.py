...
asset_file = "urdf/go1_fw3_contact.urdf"
asset_name = "go1"
loaded_assets = []
...
my_asset = gym.load_asset(sim, asset_root, asset_file)
...
print()
print_asset_info(my_asset, asset_name)
...
gym.create_actor(env, my_asset, pose, asset_name, -1, -1)
